...
from web_board.permissions import IsOwnerOrReadOnly, IsOwnerOrReadOnlyPost
from web_board.serializers import BoardSerializer, TopicSerializer, PostSerializer
...
class BoardViewSet(viewsets.ModelViewSet):
    ...
    def topics(self, request, pk=None , topic_id =None):
